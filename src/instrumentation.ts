...
export async function register() {
  ...
  try {
    ...
    const statements = [
      ...
      `CREATE INDEX IF NOT EXISTS "Job_status_latestActivityAt_idx" ON "Job"("status","latestActivityAt")`,
      `CREATE TABLE IF NOT EXISTS "JobPart" (
        ...
        "unitSell" REAL NOT NULL DEFAULT 0,
        "itemPartNumberSnapshot" TEXT,
        "notes" TEXT,
      ...
      `CREATE INDEX IF NOT EXISTS "JobHistory_jobId_idx" ON "JobHistory"("jobId")`,
      `CREATE INDEX IF NOT EXISTS "JobHistory_jobId_createdAt_idx" ON "JobHistory"("jobId","createdAt")`,
      ...
      `ALTER TABLE "Job" ADD COLUMN "createdByName" TEXT`,
      `ALTER TABLE "Job" ADD COLUMN "billingTotal" REAL`,
      `ALTER TABLE "Job" ADD COLUMN "customerSummary" TEXT`,
      `ALTER TABLE "Job" ADD COLUMN "completedAt" DATETIME`,
      `ALTER TABLE "Job" ADD COLUMN "completedByUserId" TEXT`,
      `ALTER TABLE "Job" ADD COLUMN "completedByName" TEXT`,
      `ALTER TABLE "Job" ADD COLUMN "invoiceNumber" TEXT`,
      `ALTER TABLE "Job" ADD COLUMN "invoiceDate" DATETIME`,
      `ALTER TABLE "Job" ADD COLUMN "invoicedByUserId" TEXT`,
      `ALTER TABLE "Job" ADD COLUMN "invoicedByName" TEXT`,
      `ALTER TABLE "Job" ADD COLUMN "latestActivityAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP`,
      `ALTER TABLE "JobPart" ADD COLUMN "markupPercent" REAL NOT NULL DEFAULT 0`,
      `ALTER TABLE "JobPart" ADD COLUMN "unitSell" REAL NOT NULL DEFAULT 0`,
      `ALTER TABLE "JobPart" ADD COLUMN "itemPartNumberSnapshot" TEXT`,
      `ALTER TABLE "JobPart" ADD COLUMN "lastActivityAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP`,
      `UPDATE "JobPart" SET "unitSell" = COALESCE("unitCost", 0) WHERE COALESCE("unitSell", 0) = 0`,
