  ...
  if (!token) {
    return (
      <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 text-center space-y-4">
        <p className="text-slate-400 text-sm">This reset link is invalid or has already been used.</p>
        <Link
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <Suspense fallback={<div className="text-slate-400 text-sm text-center animate-pulse">Loading…</div>}>
          <ResetPasswordForm />
        </Suspense>
      </div>
    </div>
