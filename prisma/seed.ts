    ...
    data: [
      {
        ...
        emailContacts: [{ label: "Sales", email: "contact@techsupplier.com" }],
        leadTimeD: 5,
        isPreferred: true,
        notes: "Fast shipping",
      },
      {
        ...
        emailContacts: [{ label: "Sales", email: "sales@indparts.com" }],
        leadTimeD: 10,
      ...
      },
      {
        ...
        emailContacts: [{ label: "Orders", email: "orders@localhw.com" }],
        leadTimeD: 2,
        isFastest: true,
